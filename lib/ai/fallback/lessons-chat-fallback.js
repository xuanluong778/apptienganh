...
export function buildFallbackReply(message) {
  ...
  if (/\b(hello|hi|hey)\b/.test(lower)) {
    return {
      reply: "Hi! Nice to meet you. What do you want to talk about today?",
      corrected_sentence: "Hi! Nice to meet you. I want to talk about my day.",
      ipa: "/haɪ/ /naɪs/ /tuː/ /miːt/ /juː/",
      pronunciation_tip: "Say HI with a clear long sound: /haɪ/.",
      mistakes_explanation:
        "Greeting is fine. After Hi, add a comma pause, then say Nice to meet you as one smooth phrase.",
    };
  }
  ...
  return {
    reply:
      "I understand you! To sound more natural, use full short sentences and clear stress on important words. What do you want to talk about next—school, hobbies, or family?",
